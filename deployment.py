...
bert_model_path=r'C:\Users\marcus\PycharmProjects\nlp_ner_training\model\trained'
...
if __name__=='__main__':
   # fire.Fire({'ner':NER_run})
    sentence=r'金管局總裁余偉文表示，今年本港安排和發行的綠色債券和貸款規模將以倍數增長，上半年的規模已超過去年全年的120億美元'
    result=NER_run(sentence)

    print(f'sentence: {sentence}\n')
    print(f'Name Entity: {result}')